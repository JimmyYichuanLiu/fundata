    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-4 py-4 flex flex-wrap items-center gap-4">
          ...
          <a href="/" className="text-sm text-gray-500 hover:text-gray-700">← 基金净值</a>
          <a href="/basis" className="text-sm text-gray-500 hover:text-gray-700">基差分析</a>
                      ...
                      return allCodes.map(code => {
                        ...
                        return (
                          <tr key={code} className="hover:bg-gray-50">
                            ...
                            <td className="px-4 py-3 text-gray-700 font-medium">{symbol}</td>
